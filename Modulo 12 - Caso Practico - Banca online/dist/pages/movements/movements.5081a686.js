...
})({"iMfni":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "dbb6cd245081a686";
...
},{}],"dcpgf":[function(require,module,exports) {
var _movementsHelpers = require("./movements.helpers");
var _movementsApi = require("./movements.api");
var _movementsMapper = require("./movements.mapper");
var _accountListApi = require("../account-list/account-list.api");
var _accountApi = require("../account/account.api");
var _accountMappers = require("../account/account.mappers");
var _history = require("../../core/router/history");
var _elementHelpers = require("../../common/helpers/element.helpers");
const params = _history.history.getParams();
_movementsApi.getMovementList().then((movement)=>{
    _movementsHelpers.addMovementRows(movement);
});
const isEditMode = Boolean(params.id);
if (isEditMode) {
    console.log(params.id);
    _accountApi.getAccount(params.id).then((apiAccount)=>{
        account = _accountMappers.mapAccountFromApiToViewModel(apiAccount);
        _elementHelpers.onSetValues(account);
    });
}
_accountListApi.getAccountList(params.id).then((data)=>{
    if (params.id) {
...
_movementsApi.getMovementList().then((movementList)=>{
    if (params.id) {
        let listById = [];
        movementList.forEach((el)=>{
            if (el.accountId === params.id) listById.push(el);
        });
        _movementsHelpers.addMovementRows(_movementsMapper.mapMovementsListApiToViewModel(listById));
    } else _movementsHelpers.addMovementRows(_movementsMapper.mapMovementsListApiToViewModel(movementList));
});

},{"./movements.helpers":"593wj","./movements.api":"djI6d","../account/account.api":"lIm4y","../account/account.mappers":"1TrSU","../../core/router/history":"7E2Mc","../../common/helpers/element.helpers":"lvY4R","../account-list/account-list.api":"3FwKx","./movements.mapper":"6Yidj"}],"593wj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getMovementRow", ()=>getMovementRow
);
...
},{}],"djI6d":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getMovementList", ()=>getMovementList
);
parcelHelpers.export(exports, "getMovements", ()=>getMovements
);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const url = `${"http://localhost:3000/api"}/movements`;
const getMovementList = ()=>_axiosDefault.default.get(url).then(({ data  })=>data
    )
;
const getMovements = (id)=>_axiosDefault.default.get(url, {
        params: {
            params: id
        }
    }).then(({ data  })=>data
...
},{"./../utils":"5By4s"}],"lIm4y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1TrSU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./utils":"chmkc"}],"lvY4R":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3FwKx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const getAccountList = ()=>_axiosDefault.default.get(url).then((response)=>{
        return response.data;
    })
;

},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6Yidj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "mapMovementsListApiToViewModel", ()=>mapMovementsListApiToViewModel
);
const mapMovementsListApiToViewModel = (movementsList)=>{
    return movementsList.map((movement)=>mapMovementsFromApiToViewModel(movement)
    );
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iMfni","dcpgf"], "dcpgf", "parcelRequire4bdb")

//# sourceMappingURL=movements.5081a686.js.map
