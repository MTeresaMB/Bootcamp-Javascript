...
})({"4LxSV":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
_accountListApi.getAccountList().then((accountList)=>{
    const viewModelAccountList = _accountListMappers.mapAccountListFromApiToViewModel(accountList);
    _accountListHelpers.addAccountRows(viewModelAccountList);
    viewModelAccountList.forEach((account)=>{
        _helpers.onUpdateField(`select-${account.id}`, (event)=>{
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "mapAccountListFromApiToViewModel", ()=>mapAccountListFromApiToViewModel
);
const mapAccountListFromApiToViewModel = (accountList)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4LxSV","jbtVU"], "jbtVU", "parcelRequire4bdb")
